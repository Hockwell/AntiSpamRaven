...
class SGDAlg_Default(MLAlgorithm):
    def __init__(self):
        self.clf = SGDClassifier() #LinearSVC с градиентным спуском
...
class SGDAlg_AdaptiveIters(MLAlgorithm):
    ...
    def learn(self, X_train, y_train):
        self.clf = SGDClassifier(max_iter=np.ceil(10**6 / X_train.shape[0])) #формула из рекомендаций создателей библиотеки
        self.clf.fit(X_train , y_train)

class ASGDAlg_Default(MLAlgorithm):
    def __init__(self):
        self.clf = SGDClassifier(average=True)

class LinearSVCAlg_Default(MLAlgorithm): #SVM с линейной функцией
    def __init__(self):
        self.clf = svm.LinearSVC(loss='squared_hinge')

class LinearSVCAlg_Balanced(MLAlgorithm): 
    def __init__(self):
        self.clf = svm.LinearSVC(class_weight='balanced', loss='squared_hinge')

class LinearSVCAlg_MoreSupports(MLAlgorithm): 
    def __init__(self):
        self.clf = svm.LinearSVC(loss='squared_hinge', tol=0.1)
...
class SVCAlg_RBF_Aggr(MLAlgorithm):
    def __init__(self):
        self.clf = svm.SVC(kernel='rbf', gamma='scale', C=0.01)
    
class PAA_I_Default(MLAlgorithm):
    def __init__(self):
        self.clf = PassiveAggressiveClassifier(loss = 'hinge')

class PAA_II_Default(MLAlgorithm):
    def __init__(self):
        self.clf = PassiveAggressiveClassifier(loss = 'squared_hinge')

class PAA_II_Balanced(MLAlgorithm):
    def __init__(self):
        self.clf = PassiveAggressiveClassifier(loss = 'squared_hinge', class_weight='balanced')
...
class KNeighborsAlg_Default(MLAlgorithm):
    def __init__(self):
        self.clf = KNeighborsClassifier(n_jobs = self.n_jobs)

class RandomForestAlg_Small(MLAlgorithm):
    def __init__(self):
        self.clf = RandomForestClassifier(n_jobs = self.n_jobs, n_estimators=10)

class RandomForestAlg_Medium(MLAlgorithm):
    def __init__(self):
        self.clf = RandomForestClassifier(n_jobs = self.n_jobs, n_estimators=50)

class RandomForestAlg_Big(MLAlgorithm):
    def __init__(self):
        self.clf = RandomForestClassifier(n_jobs = self.n_jobs, n_estimators=300)

class RandomForestAlg_Default(MLAlgorithm):
    def __init__(self):
        self.clf = RandomForestClassifier(n_jobs = self.n_jobs, n_estimators=100)

class RandomForestAlg_BigBootstrap75(MLAlgorithm):
    def __init__(self):
        self.clf = RandomForestClassifier(n_jobs = self.n_jobs, n_estimators=300, max_samples=0.75)

class RandomForestAlg_Bootstrap90(MLAlgorithm):
    def __init__(self):
        self.clf = RandomForestClassifier(n_jobs = self.n_jobs, max_samples=0.9)

class RandomForestAlg_MDepth20(MLAlgorithm):
    def __init__(self):
        self.clf = RandomForestClassifier(n_jobs = self.n_jobs, max_depth=20)

class RandomForestAlg_MDepth30(MLAlgorithm):
    def __init__(self):
        self.clf = RandomForestClassifier(n_jobs = self.n_jobs, max_depth=30)

class RandomForestAlg_Balanced(MLAlgorithm):
    def __init__(self):
        self.clf = RandomForestClassifier(n_jobs = self.n_jobs, class_weight="balanced")
