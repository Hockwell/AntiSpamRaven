...
class AlgsBestCombinationSearcher(object):
    ...
    def __tune(self, X, y, k_folds, algs, enable_OCC, max_combination_length, 
        ...
        def make_algs_combinations(algs_list):
            def init_algs_combis(combis_list, combis_type, min_length = 1, max_length = max_combination_length):
            ...
            init_algs_combis(self.__algs_DC, AlgsBestCombinationSearcher.CombinationsTypes.DISJUNCTIVE, min_length=2, max_length=max_combination_length)
            if (enable_OCC):
                init_algs_combis(self.__algs_CC, AlgsBestCombinationSearcher.CombinationsTypes.CONJUNCTIVE, min_length=2, max_length=max_combination_length)
        ...
        self.__X = X
        self.__y = y
        self.__combination_length = max_combination_length #данный параметр нужен, если алгоритм общего вида и способен расставлять
